#
# Module manifest for module 'PSGet_PoshProgressBar'
#
# Generated by: Micah Rairdon
#
...
NestedModules = @('MaterialDesignColors.dll', 
               'MaterialDesignThemes.Wpf.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Close-ProgressBar', 'New-Progressbar', 'Write-ProgressBar'
...
FileList = 'MaterialDesignColors.dll', 'MaterialDesignThemes.Wpf.dll', 
               'PoshProgressBar.psd1', 'PoshProgressBar.psm1', 
